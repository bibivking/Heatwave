...
x = pd.read_csv(fname, names=["wt_depth","deltaT"], sep=" ", skipinitialspace=True)
sns.displot(x, x="wt_depth", y="deltaT")
plt.xlim(0, 10)
plt.ylim(-4, 6)
plt.savefig("scatter_density_deltaT_2000-19.png")


fname1 = "./txt/scatter_WTD_deltaT_CTL_PFT-tree_2001-09.txt"
x1 = pd.read_csv(fname1, names=["wt_depth","deltaT"], sep=" ", skipinitialspace=True)
sns.displot(x1, x="wt_depth", y="deltaT")
plt.xlim(0, 10)
plt.ylim(-4, 6)
plt.savefig("scatter_density_deltaT_2001-09.png")


fname2 = "./txt/scatter_WTD_deltaT_CTL_PFT-tree_2010-11.txt"
x2 = pd.read_csv(fname2, names=["wt_depth","deltaT"], sep=" ", skipinitialspace=True)
sns.displot(x2, x="wt_depth", y="deltaT")
plt.xlim(0, 10)
plt.ylim(-4, 6)
plt.savefig("scatter_density_deltaT_2010-11.png")


fname3 = "./txt/scatter_WTD_deltaT_CTL_PFT-tree_2017-19.txt"
x3 = pd.read_csv(fname3, names=["wt_depth","deltaT"], sep=" ", skipinitialspace=True)
sns.displot(x3, x="wt_depth", y="deltaT")
plt.xlim(0, 10)
plt.ylim(-4, 6)
plt.savefig("scatter_density_deltaT_2017-19.png")
