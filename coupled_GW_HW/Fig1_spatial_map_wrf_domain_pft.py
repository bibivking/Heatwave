...
def spatial_map_wrf_domain(file_paths, wrf_path):
    ...
    line = ax1.plot(x_values, y_values,c=almost_black, alpha = 1, transform=ccrs.PlateCarree())

    # add square
    ax1.add_patch(Polygon([[148., -36.5], [149., -36.5], [149., -35.5], [148., -35.5]],
                 closed=True,color=almost_black, fill=False))
    ax1.text(0.0, -0.2, "Water", transform=ax1.transAxes, verticalalignment='top', bbox=props, fontsize=10)
    ax1.text(0.2, -0.2, "BEF", transform=ax1.transAxes, verticalalignment='top', bbox=props, fontsize=10)
    ax1.text(0.35, -0.2, "Shrub", transform=ax1.transAxes, verticalalignment='top', bbox=props, fontsize=10)
    ax1.text(0.54, -0.2, "Grass", transform=ax1.transAxes, verticalalignment='top', bbox=props, fontsize=10)
    ax1.text(0.71, -0.2, "Crop", transform=ax1.transAxes, verticalalignment='top', bbox=props, fontsize=10)
    ax1.text(0.83, -0.2, "Barren land", transform=ax1.transAxes, verticalalignment='top', bbox=props, fontsize=10)
    ...
    ax2.add_patch(Polygon([[148., -36.5], [149., -36.5], [149., -35.5], [148., -35.5]],
                 closed=True,color=almost_black, fill=False))
    line = ax2.plot(x_values, y_values,c= almost_black, alpha = 1, transform=ccrs.PlateCarree())
    # ================ Plotting WTD ================
    ...
    ax3.add_patch(Polygon([[148., -36.5], [149., -36.5], [149., -35.5], [148., -35.5]],
                 closed=True,color=almost_black, fill=False))
    line = ax3.plot(x_values, y_values,c=almost_black, alpha = 1, transform=ccrs.PlateCarree())
   ...
   # ================ Plotting WTD ================
    ...
    ax4.add_patch(Polygon([[148., -36.5], [149., -36.5], [149., -35.5], [148., -35.5]],
                 closed=True,color=almost_black, fill=False))
    line = ax4.plot(x_values, y_values,c=almost_black, alpha = 1, transform=ccrs.PlateCarree())
    ...
    ax5.add_patch(Polygon([[148., -36.5], [149., -36.5], [149., -35.5], [148., -35.5]],
                 closed=True,color=almost_black, fill=False))
    line = ax5.plot(x_values, y_values,c=almost_black, alpha = 1, transform=ccrs.PlateCarree())
