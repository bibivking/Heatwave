...
def plot_spatial_fwsoil_qle_tmax(case_names, wrf_path, loc_lat=None, loc_lon=None, seconds=None, message=None):
    ...
    for i, case_name in enumerate(case_names):
        ...
        for j in np.arange(3):
            ...
            # set y label
            if j == 0:
                ax[i,j].set_ylabel(label_y[i],labelpad=-0.1)#, fontsize=12)
...
def plot_spatial_Rnet_LW_SW(case_names, loc_lat=None, loc_lon=None, seconds=None, message=None):
    ...
    for i, case_name in enumerate(case_names):
        ...
        if i == 0:
            ...
            ax[i,1].set_xlabel(label_x[1],labelpad=-0.1)#, fontsize=12)
            ax[i,2].set_xlabel(label_x[2],labelpad=-0.1)#, fontsize=12)
            ax[i,3].set_xlabel(label_x[3],labelpad=-0.1)#, fontsize=12)
            ax[i,4].set_xlabel(label_x[4],labelpad=-0.1)#, fontsize=12)
