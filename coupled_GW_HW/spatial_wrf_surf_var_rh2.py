...
def plot_spatial_wrf_surf_var_period_mean(is_diff, message, file_paths, case_names, var_name,
                                          ts_s, ts_e, ts = None):
    ...
    if ts == None:
        fig.savefig("./plots/spatial_wrf_surf"+diff_flag+message+"_"+var_name+"_"+case_string
