...
def plot_profile_wrf_wind(file_paths, var_name, var_units, time_s, time_e, seconds=None, message=None,calc_type=None):
    ...
    scale = 5
    q = ax.quiver(to_np(xy_loc), to_np(vertical), ua_cross, wa_cross, angles='xy', scale_units='xy', scale=scale, pivot='middle') # width=0.0002,
    ...
    fig.savefig("./plots/5Nov/wrf_prof/profile_wrf_wind_"+message, bbox_inches='tight', pad_inches=0.1)
